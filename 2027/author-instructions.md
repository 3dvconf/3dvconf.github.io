...
Important note: **We may desk-reject papers that contain authors without a valid OpenReview profile after the paper submission deadline (August 28, 2026)**.
...
Note that all new OpenReview profiles that are created *without an institutional email* will need to undergo a moderation process on OpenReview's side. This process can take up to two weeks, so please create profiles as soon as possible.
